        ...
        case "teamMember" : {
                $response = '<div id="shortcodes_' . $name . '_form">
						 	<table id="cocobasic_shortcode_' . $name . '">
								...
								<tr>
									<th><label for="shortcode_' . $name . '_size">' . esc_html__('Image Size', 'cocobasic-shortcode') . '</label></th>
									<td><select id="shortcode_' . $name . '_size"><option>one_third</option><option>one_half</option><option>one_fourth</option></select><br /><small>' . esc_html__('open link in same/new tab', 'cocobasic-shortcode') . '</small></td>
								</tr>
								<tr>
								<th><label for="shortcode_' . $name . '_img">' . esc_html__('Set Image', 'cocobasic-shortcode') . '</label></th>
								<td><label for="upload_image">
								...
								<tr>
									<th><label for="shortcode_' . $name . '_href">' . esc_html__('URL to Page/Post/External Site', 'cocobasic-shortcode') . '</label></th>
									<td><input style="width:300px" name="' . $name . '" id="shortcode_' . $name . '_href" /><br /><small>' . esc_html__('Use this field to link member name to some Page/Post/External Site (optional)', 'cocobasic-shortcode') . '</small></td>
								</tr>
								<tr>
									<th><label for="shortcode_' . $name . '_target">' . esc_html__('Target', 'cocobasic-shortcode') . '</label></th>
									<td><select id="shortcode_' . $name . '_target"><option>_self</option><option>_blank</option></select><br /><small>' . esc_html__('open link in same/new tab', 'cocobasic-shortcode') . '</small></td>
								</tr>
							</table>
							<p class="submit">
								<input type="button" id="submit_shortcode" class="button-primary" value="' . esc_html__('Insert Shortcode', 'cocobasic-shortcode') . '" name="submit" />
