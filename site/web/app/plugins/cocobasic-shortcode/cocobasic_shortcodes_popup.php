    ...
    <body>
        <div id="cocobasic_shortcodes_popup">
            <ul>  
                ...
                <li><a id="cocobasic_text_slider" href="#"><?php echo esc_html__('Text Slider', 'cocobasic-shortcode'); ?></a></li>                                              
                <li class="shortcode_divider_line">     </li>	 
                <li><a id="cocobasic_team_holder" href="#"><?php echo esc_html__('Team Holder', 'cocobasic-shortcode'); ?></a></li>
                <li><a id="cocobasic_team_member" href="#"><?php echo esc_html__('Team Member', 'cocobasic-shortcode'); ?></a></li>                
                <li class="shortcode_divider_line">     </li>	 
